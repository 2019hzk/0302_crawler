...
PLATFORM = os.getenv("CRAWLER_PLATFORM", "dy")  # 平台，xhs | dy | ks | bili | wb | tieba | zhihu

# 是否使用海外版小红书 (rednote.com)
# 开启后 API 走 webapi.rednote.com，cookie 域使用 .rednote.com
XHS_INTERNATIONAL = os.getenv("XHS_INTERNATIONAL", "False") == "True"

KEYWORDS = os.getenv("CRAWLER_KEYWORDS", "融资余额,黄金,OPPO,长焦,收益率,PCB,黄仁勋,原油,白银,茅台")  # 关键词搜索配置，以英文逗号分隔
LOGIN_TYPE = os.getenv("CRAWLER_LOGIN_TYPE", "qrcode")  # qrcode or phone or cookie
COOKIES = os.getenv("CRAWLER_COOKIES", "")
CRAWLER_TYPE = os.getenv("CRAWLER_TYPE", "search")  # 爬取类型，search(关键词搜索) | detail(帖子详情)| creator(创作者主页数据)
...
HEADLESS = os.getenv("CRAWLER_HEADLESS", "True") == "True"
...
ENABLE_CDP_MODE = os.getenv("CRAWLER_ENABLE_CDP_MODE", "False") == "True"
...
CDP_CONNECT_EXISTING = os.getenv("CRAWLER_CDP_CONNECT_EXISTING", "True") == "True"
...
SAVE_DATA_OPTION = os.getenv("CRAWLER_SAVE_DATA_OPTION", "db")  # csv or db or json or sqlite or postgresql
...
CRAWLER_MAX_NOTES_COUNT = int(os.getenv("CRAWLER_MAX_NOTES_COUNT", "50"))
...
ENABLE_GET_COMMENTS = os.getenv("CRAWLER_ENABLE_GET_COMMENTS", "True") == "True"

# Control the number of crawled first-level comments (single video/post)
CRAWLER_MAX_COMMENTS_COUNT_SINGLENOTES = int(os.getenv("CRAWLER_MAX_COMMENTS_COUNT_SINGLENOTES", "20"))
