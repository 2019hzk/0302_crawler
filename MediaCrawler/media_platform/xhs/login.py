...
class XiaoHongShuLogin(AbstractLogin):
    ...
    async def begin(self):
        ...
        if config.LOGIN_TYPE == "qrcode" or config.LOGIN_TYPE == "phone":
            utils.logger.info("[XiaoHongShuLogin.begin] Opening xiaohongshu.com for manual login, please log in within 2 minutes ...")
            ...
            try:
                ...
                utils.logger.info("[XiaoHongShuLogin.begin] login failed please confirm ...")
                sys.exit()
