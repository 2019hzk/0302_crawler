...
class WeiboLogin(AbstractLogin):
    ...
    async def begin(self):
        ...
        if config.LOGIN_TYPE == "qrcode" or config.LOGIN_TYPE == "phone":
            utils.logger.info("[WeiboLogin.begin] Opening weibo SSO login page, please log in within 10 minutes ...")
            ...
            try:
                ...
                utils.logger.info("[WeiboLogin.begin] login failed please confirm ...")
                sys.exit()
